...
@Loggable
final class LineDockTilePlugin: NSObject, NSDockTilePlugIn {
    private var dockTile: NSDockTile?
    private var notificationObserver: Any?
    private let appBundleID = "com.nnecec.Line"
    private let notificationName = Notification.Name("com.nnecec.Line.iconChanged")
